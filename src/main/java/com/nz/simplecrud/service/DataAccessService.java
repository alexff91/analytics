...
/**
 * Implementation of the generic Data Access Service All CRUD (create, read, update, delete) basic
 * data access operations for any persistent object are performed in this class.
