  ...
  public Object getAsObject(FacesContext context, UIComponent component, String value) {
    ...
    if (value.equalsIgnoreCase("")) {
      ...
      FacesContext.getCurrentInstance()
          .addMessage("newPassword", new FacesMessage("Password cannot be less than 4 letters!"));
      return value;
    }
    try {
      ...
      Logger.getLogger(SHAConverter.class.getName())
          .log(Level.SEVERE, null, "SHAConverter.getAsObject:" + unsupportedEncodingException);
      return "";
    }
  }
