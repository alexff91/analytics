...
public class DescriptiveStatistics implements Serializable {
  ...
  public void descriptiveStatistics() {
    try {
      ...
      List<org.apache.commons.math3.stat.descriptive.DescriptiveStatistics> decList
          = new LinkedList<org.apache.commons.math3.stat.descriptive.DescriptiveStatistics>();
      int j = 1;
      ...
      for (int i = 0; i < decList.size(); i++) {
        ...
        double populationVariance = ExporterBean
            .roundTo2Decimals(deccriptor.getPopulationVariance());
